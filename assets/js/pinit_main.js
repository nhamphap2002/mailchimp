!function (a, b, c) {
    var d = a[c.k] = {w: a, d: b, a: c, s: {}, f: function () {
            return{callback: [], get: function (a, b) {
                    var c = null;
                    ...
                    c = d.f.callback.length, e = d.a.k + ".f.callback[" + c + "]", d.f.callback[c] = function (a) {
                        a && (a.status && "failure" === a.status ? (g = a.message || a.status, "string" === typeof d.v.config.error && "function" === typeof d.w[d.v.config.error] && d.w[d.v.config.error](g), f = d.d.getElementById(d.a.k + ".f.callback[" + c + "]"), f && f.src && d.f.log("&type=api_error&code=" + a.code + "&msg=" + g + "&url=" + encodeURIComponent(f.src.split("?")[0]))) : b(a, c)), d.f.kill(e)
                    }, a.match(/\?/) && (h = "&"), d.d.b.appendChild(d.f.make({SCRIPT: {id: e, type: "text/javascript", charset: "utf-8", src: a + h + "callback=" + e}}))
                }, debug: function (a, b) {
                    ...
                    var b = {height: d.f.getData(a, "height") || d.v.config.height, color: d.f.getData(a, "color") || d.v.config.color, shape: d.f.getData(a, "shape") || d.v.config.shape, assets: d.f.getData(a, "lang") || d.v.config.lang, zero: d.f.getData(a, "zero") || null, pad: d.f.getData(a, "count-pad") || null, config: d.f.getData(a, "config") || "none"}, c = d.f.getData(a, "id");
                    ...
                    if (a.height > d.a.minImgSize && a.width > d.a.minImgSize && !a.src.match(/^data/)) {
                        ...
                        b.id ? (e = d.v.endpoint.repin.replace(/%s/, b.id), d.s.floatingButton = d.f.make({A: {className: c, title: "Pin it!", "data-pin-log": "button_pinit_floating_repin", "data-pin-href": e}})) : (e = d.v.endpoint.create + "guid=" + d.v.guid, e = e + "&url=" + encodeURIComponent(d.f.getData(a, "url") || d.d.URL), e = e + "&media=" + encodeURIComponent(d.f.getData(a, "media") || a.src), e = e + "&description=" + encodeURIComponent(d.f.getSelection() || d.f.getData(a, "description") || a.title || a.alt || d.d.title), d.s.floatingButton = d.f.make({A: {className: c, title: "Pin it!", "data-pin-log": "button_pinit_floating", "data-pin-href": e}})), d.d.b.appendChild(d.s.floatingButton), d.s.floatingButton.style.top = f.top + d.a.floatingButtonOffsetTop + "px", d.s.floatingButton.style.left = f.left + d.a.floatingButtonOffsetLeft + "px", d.s.floatingButton.style.zIndex = "8675309", d.s.floatingButton.style.display = "block"
                    }
                }, over: function (a) {
                    var b, c;
                    ...
                    if (b = d.f.getEl(a), b && (c = d.f.getData(b, "log")))
                        if ("embed_pin_play" === c) {
                        ...
                        } else if (e = d.f.getData(b, "href"))
                            switch (d.f.log("&type=" + c + "&href=" + encodeURIComponent(e)), b.className.match(/hazClick/) || (b.className = b.className + " " + d.a.k + "_hazClick"), c) {
                                case"button_pinit":
                            ...
                            e = d.f.get(b, "href"), e && d.f.log("&type=" + c + "&href=" + encodeURIComponent(e))
                }, filter: function (a) {
                    var b, c;
                    b = "", c = "";
                    try {
                    ...
                    var a = function () {
                        for (var b = d.d.getElementsByTagName("SCRIPT"), c = 0, e = b.length; c < e; c += 1)
                            b[c] && b[c].src && b[c].src.match(/^https?:\/\/log\.pinterest\.com/) && d.f.kill(b[c]);
                    ...
                    var e = {height: d.a.tile.scale.height, width: d.a.tile.scale.width}, f = d.f.getData(a, "scale-height");
                    ...
                    for (var k = d.f.make({SPAN: {className: d.a.k + "_embed_grid_ct"}}), l = 0, m = [], n = 0, o = b.length; n < o; n += 1) {
                        var p = d.f.make({SPAN: {innerHTML: b[n].description}}), q = d.f.make({A: {className: d.a.k + "_embed_grid_th", title: p.innerHTML, "data-pin-href": d.v.endpoint.repin.replace(/%s/, b[n].id), "data-pin-id": b[n].id, "data-pin-log": c + "_thumb"}}), r = b[n].images[d.a.pinWidget.imgKey], s = {height: r.height * (e.width / r.width), width: e.width}, t = d.f.make({IMG: {src: r.url, "data-pin-nopin": "true", height: s.height, width: s.width, className: d.a.k + "_embed_grid_img", alt: b[n].description}});
                        if (t.style.height = s.height + "px", t.style.width = s.width + "px", t.style.minHeight = s.height + "px", t.style.minWidth = s.width + "px", t.style.marginTop = 0 - s.height / d.a.tile.style.margin + "px", s.height > e.height && (s.height = e.height), q.appendChild(t), q.style.height = s.height + "px", q.style.width = s.width + "px", m[l])
                            for (var u = 1e4, v = 0; v < i; v += 1)
                                m[v] < u && (u = m[v], l = v);
                        else
                            m[l] = 0;
                        q.style.top = m[l] + "px", q.style.left = l * (e.width + d.a.tile.style.margin) + "px", m[l] = m[l] + s.height + d.a.tile.style.margin, q.appendChild(t), k.appendChild(q), l = (l + 1) % i
                    }
                    for (var w = 0, n = 0; n < m.length; n += 1)
                        m[n] > w && (w = m[n]);
                    return k.style.height = w + "px", j.appendChild(k), d.v.userAgent.match(/Mac OS X/) && (j.className = j.className + " " + d.a.k + "_embed_grid_scrolling_okay"), j
                }, makeHeader: function (a, b, c, e) {
                    var f = d.v.endpoint.pinterest + b.href.split(".com")[1], g = d.f.make({SPAN: {className: d.a.k + "_embed_grid_hd"}}), h = d.f.make({A: {className: d.a.k + "_avatar", "data-pin-log": c, href: f, target: "_blank"}}), i = d.f.make({IMG: {alt: d.f.filter(a.data.user.full_name), title: d.f.filter(a.data.user.full_name), src: a.data.user.image_small_url.replace(/_30.jpg/, "_60.jpg")}});
                    if (h.appendChild(i), g.appendChild(h), e) {
                        var j = d.f.make({A: {className: d.a.k + "_embed_grid_first", innerHTML: d.f.filter(a.data.user.full_name), target: "_blank", "data-pin-href": f, "data-pin-log": c}});
                        j.style.width = d.v.renderedWidth - 45 + "px", g.appendChild(j);
                        var k = d.f.make({A: {className: d.a.k + "_embed_grid_second", innerHTML: d.f.filter(a.data.board.name), "data-pin-href": f, "data-pin-log": c}});
                        k.style.width = d.v.renderedWidth - 45 + "px", g.appendChild(k)
                    } else {
                        var l = d.f.make({A: {className: d.a.k + "_embed_grid_mid", innerHTML: d.f.filter(a.data.user.full_name), "data-pin-log": c, "data-pin-href": f}});
                        l.style.width = d.v.renderedWidth - 45 + "px", g.appendChild(l)
                    }
                    return g
                }, makeFooter: function (a, b, c) {
                    var e, f, g, h;
                    h = d.v.endpoint.pinterest + a.href.split(".com")[1], e = d.f.make({A: {className: d.a.k + "_embed_grid_ft", "data-pin-log": b, "data-pin-href": h}}), f = d.f.make({SPAN: {className: d.a.k + "_embed_grid_ft_logo", "data-pin-log": b, "data-pin-href": h}});
                    var i = d.v.strings;
                    return c && d.a.strings[c] && (i = d.a.strings[c]), d.v.renderedWidth > d.a.tile.minWidthToShowAuxText ? (g = d.f.make({SPAN: {innerHTML: i.seeOn, "data-pin-log": b, "data-pin-href": h}}), i.seeOnTextAfterLogo ? (e.appendChild(f), e.appendChild(g)) : (e.appendChild(g), e.appendChild(f))) : e.appendChild(f), e
                }, cssHook: function (a, b) {
                    var c = d.f.getData(a, "css-hook");
                    c && (b.className = b.className + " " + c)
                }, fireBookmark: function () {
                    d.d.b.appendChild(d.f.make({SCRIPT: {type: "text/javascript", charset: "utf-8", pinMethod: "button", src: d.a.endpoint.bookmark + "?r=" + 99999999 * Math.random()}}))
                }, ping: {log: function (a, b) {
                    }, count: function (a, b) {
                        ...
                        if (c && a.data && a.data[0]) {
                            if (a.data[0].error)
                                return void("string" === typeof d.v.config.error && "function" === typeof d.w[d.v.config.error] && d.w[d.v.config.error](a.data[0].error));
                            ...
                            if (e.images && (f = e.images[d.a.pinWidget.imgKey]), e && e.id && e.description && f.url && f.width && f.height) {
                                ...
                                var i = d.f.make({SPAN: {className: d.a.k + "_embed_pin", "data-pin-id": e.id}}), j = d.f.getData(c, "style");
                                "plain" !== j && (i.className = i.className + " " + d.a.k + "_fancy");
                                var k = d.f.make({A: {className: d.a.k + "_embed_pin_link", "data-pin-log": "embed_pin", "data-pin-href": d.v.endpoint.repin.replace(/%s/, e.id)}});
                                ...
                                e.embed && "gif" !== e.embed.type && e.embed.src ? (embedSrc = e.embed.src.replace(/autoplay=/i, "nerfAutoPlay="), player = d.f.make({IFRAME: {className: d.a.k + "_embed_pin_link_iframe", src: embedSrc}}), player.width = f.width, player.height = f.height, player.frameBorder = "0", i.appendChild(player)) : (img = d.f.make({IMG: {className: d.a.k + "_embed_pin_link_img", alt: e.description, "data-pin-nopin": "true", src: f.url, width: f.width, height: f.height, "data-pin-log": "embed_pin_img", "data-pin-href": d.v.endpoint.pinterest + "/pin/" + e.id + "/"}}), img.style.width = f.width + "px", img.style.height = f.height + "px", k.appendChild(img), rpc = d.a.k + "_repin", "ja" === h && (rpc += "_ja"), repin = d.f.make({I: {className: rpc, "data-pin-id": e.id, "data-pin-log": "embed_pin_repin", "data-pin-href": d.v.endpoint.repin.replace(/%s/, e.id)}}), k.appendChild(repin), e.embed && e.embed.type && "gif" === e.embed.type && (play = d.f.make({I: {className: d.a.k + "_play " + d.a.k + "_paused", innerHTML: "&#9654; GIF", "data-pin-log": "embed_pin_play"}}), k.appendChild(play)), i.appendChild(k));
                                var m = d.f.make({SPAN: {className: d.a.k + "_embed_pin_desc", innerHTML: d.f.filter(e.description)}});
                                if (e.attribution && e.attribution.url && e.attribution.author_name && e.attribution.provider_icon_url) {
                                    ...
                                    n.appendChild(d.f.make({IMG: {className: d.a.k + "_embed_pin_attrib_icon", src: e.attribution.provider_icon_url}})), n.appendChild(d.f.make({SPAN: {className: d.a.k + "_embed_pin_attrib", innerHTML: g.attribTo + ' <a href="' + e.attribution.url + '" target="_blank">' + d.f.filter(e.attribution.author_name) + "</a>"}})), m.appendChild(n)
                                }
                                if (e.repin_count || e.like_count) {
                                    var o = d.f.make({SPAN: {className: d.a.k + "_embed_pin_stats"}});
                                    if (e.repin_count) {
                                        var p = d.f.make({SPAN: {className: d.a.k + "_embed_pin_stats_repin_count", innerHTML: "" + e.repin_count}});
                                        o.appendChild(p)
                                    }
                                    if (e.like_count) {
                                        var q = d.f.make({SPAN: {className: d.a.k + "_embed_pin_stats_like_count", innerHTML: "" + e.like_count}});
                                        o.appendChild(q)
                                    }
                                    m.appendChild(o)
                                }
                                if (i.appendChild(m), e.pinner && e.pinner.profile_url && e.pinner.image_small_url && e.pinner.full_name) {
                                    ...
                                    var r = d.f.make({SPAN: {className: d.a.k + "_embed_pin_text"}}), s = d.f.make({A: {"data-pin-log": "embed_pin_pinner", href: e.pinner.profile_url, target: "_blank"}});
                                    s.appendChild(d.f.make({IMG: {className: d.a.k + "_embed_pin_text_avatar", alt: d.f.filter(e.pinner.full_name), title: d.f.filter(e.pinner.full_name), src: e.pinner.image_small_url}})), r.appendChild(s), r.appendChild(d.f.make({SPAN: {className: d.a.k + "_embed_pin_text_container", innerHTML: '<span data-pin-log="embed_pin_pinner" data-pin-href="' + e.pinner.profile_url + '" class="' + d.a.k + '_embed_pin_text_container_pinner">' + d.f.filter(e.pinner.full_name) + '</span><span data-pin-log="embed_pin_board" data-pin-href="' + d.v.endpoint.pinterest + e.board.url + '" class="' + d.a.k + '_embed_pin_text_container_board">' + d.f.filter(e.board.name) + "</span>"}})), i.appendChild(r)
                                }
                    ...
                    return b === a && (a = encodeURIComponent(a)), a.match(/^http/i) || (a.match(/^%2F%2F/i) || (a = "%2F%2F" + a), a = "http%3A" + a, d.f.debug("fixed URL: " + a)), a
                }, render: {buttonBookmark: function (a) {
                        ...
                        var e = d.f.make({A: {"data-pin-href": a.href, "data-pin-log": "button_pinit_bookmarklet", className: c}});
                        if ((d.f.getData(a, "zero") || d.v.config.zero) && d.f.set(e, d.a.dataAttributePrefix + "zero", !0), d.a.config.pinItCountPosition[b.config] === !0 && "rect" === b.shape) {
                            ...
                            var f = d.f.make({SPAN: {className: d.a.k + "_hidden", id: d.a.k + "_pin_count_" + d.f.callback.length, innerHTML: "<i></i>"}});
                        ...
                        "round" === b.shape && (c = d.a.k + "_pin_it_button_en_" + b.height + "_red_round " + d.a.k + "_pin_it_button_inline_en_" + b.height + "_red_round");
                        var e, f;
                        f = d.f.parse(a.href, {url: !0, media: !0, description: !0}), f.media ? f.media = d.f.fixUrl(f.media) : (f.media = "", d.f.debug("no media found; click will pop bookmark")), f.url ? f.url = d.f.fixUrl(f.url) : (f.url = encodeURIComponent(d.d.URL), d.f.debug("no url found; click will pin this page")), f.description || (f.description = encodeURIComponent(d.d.title || "")), d.v.buttonId = d.v.buttonId + 1, e = d.v.endpoint.create + "guid=" + d.v.guid + "-" + d.v.buttonId + "&url=" + f.url + "&media=" + f.media + "&description=" + f.description;
                        ...
                        if (d.a.config.pinItCountPosition[h] === !0 ? (d.f.set(g, d.a.dataAttributePrefix + "config", h), g.className = g.className + " " + d.a.k + "_pin_it_" + b.config + "_" + b.height, b.pad && (g.className = g.className + " " + d.a.k + "_pin_it_" + b.config + "_" + b.height + "_pad")) : g.className = g.className + " " + d.a.k + "_pin_it_none", b.id && f.media && (d.f.set(g, "data-pin-log", "button_pinit_repin"), d.f.set(g, "data-pin-id", b.id), d.f.set(g, "data-pin-href", d.v.endpoint.repin.replace(/%s/, b.id) + "?media=" + f.media)), f.url) {
                            if ("rect" === b.shape) {
                                var i = d.f.make({SPAN: {className: d.a.k + "_hidden", id: d.a.k + "_pin_count_" + d.f.callback.length, innerHTML: "<i></i>"}});
                        ...
                        "28" === c && (b += "_28");
                        var e = d.f.make({A: {href: a.href, className: d.a.k + b, innerHTML: a.innerHTML, "data-pin-href": a.href + "?guid=" + d.v.guid + "-" + d.v.buttonId}});
                    ...
                    var b, c, e, f, g, h = a.getElementsByTagName("A"), i = {vertical: "above", horizontal: "beside"}, j = [];
                    ...
                    return g = d.a.domains[h], g.assets && (assetMatch = g.assets), g.strings && d.a.strings[g.strings] && (stringMatch = g.strings), h = h.split(":")[0], {lang: j, domain: h, strings: stringMatch, assets: assetMatch}
                }, init: function () {
                    if (d.d.b = d.d.getElementsByTagName("BODY")[0], d.d.b) {
                        d.d.h = d.d.getElementsByTagName("HEAD")[0], d.v = {resolution: 1, here: d.d.URL.split("#")[0], hazFloatingButton: !1, config: {color: "gray", assets: "en", height: "20", shape: "rect"}, strings: d.a.strings.en, guid: "", buttonId: 0, userAgent: d.w.navigator.userAgent, countButton: 0, countFollow: 0, countPin: 0, countBoard: 0, countProfile: 0}, null !== d.v.userAgent.match(/MSIE/) && (d.v.hazIE = !0);
